<?php
/**
 * Veritrans VT Direct virtual account Helper Data
 *
 * @category   Mage
 ...
 */
class Veritrans_Vtvirtual_Helper_Data extends Mage_Core_Helper_Abstract
{

	// Veritrans payment method title 
	function _getTitle(){
		return Mage::getStoreConfig('payment/vtvirtual/title');
	}
	...
	function _getMerchantID(){
		return Mage::getStoreConfig('payment/vtvirtual/merchant_id');
	}
	...
	function _getMerchantHashKey(){
		return Mage::getStoreConfig('payment/vtvirtual/merchant_hash');
	}

	// Installment bank
	function _getInstallmentBank(){
		return Mage::getStoreConfig('payment/vtvirtual/installment_bank');
	}

	// Installment terms, separate by comma (,) ex. 3,6,12
	function _getInstallmentTerms(){
		return Mage::getStoreConfig('payment/vtvirtual/installment_terms');
	}
	
	// progress side bar, if true then show logo image, vice versa
	function _getInfoTypeIsImage(){
		return Mage::getStoreConfig('payment/vtvirtual/info_type');
	}
	
	// Message to be shown when Veritrans payment method is chosen
	function _getFormMessage(){
		return Mage::getStoreConfig('payment/vtvirtual/form_message');
	}
}